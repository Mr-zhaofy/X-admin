        	...
        	<?php foreach( $data as $k=>$v ){?>
        		<tr>
		            ...
		            <td class="td-manage">
		              	...
		              	<a onclick="x_admin_show('配置权限','/auth/config_power?role_id=<?php echo $v['role_id']?>')" href="javascript:;"  title="配置权限">
		              		<i class="layui-icon">&#xe614;</i>
		              	</a>
		              	<a title="编辑"  onclick="x_admin_show('编辑','role-add.html')" href="javascript:;">
		                	<i class="layui-icon">&#xe642;</i>
		              	</a>
		              	<a title="删除" href="javascript:;" class='del' value="<?php echo $v['role_id']?>" >
		                	<i class="layui-icon">&#xe640;</i>
		              	</a>
		            </td>
	          	</tr>
      ...
      /**********删除************/
        $('.del').click(function(){
          ...
          layer.confirm('确认要删除吗，删除后不能恢复',{title:"删除确认"} ,function(index){
                $.post('/auth/role_delete',{role_id:role_id},function(data){
                    if(data == 1){
