    ...
    <div class="x-body">
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <button  class="layui-btn but" lay-filter="add" lay-submit="">
                  添加
              </button>
          </div>
      </form>
    ...
    <script>
        layui.use(['form','layer'], function(){
          ...
          $('.but').click(function(){
          	...
          	var password = $('#L_pass').val();    //密码
          	var repass = $('#L_repass').val();    //确认密码
          	var email = $('#L_email').val();      //邮箱
          	var role = $("input:checkbox[name='role']:checked").val();
          	$.post('/auth/execute_admin_add',{username:username,password:password,repass:repass,email:email,role:role},function(data){
          		if(data == 1){
